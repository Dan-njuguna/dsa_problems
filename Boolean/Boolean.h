...
/*
    This file contains the:
        ...
        3. Constructor for the modified boolean.
        4. Helper function declarations for the Boolean_type struct.
...
/**
 * The enum definition for the type of pointer passed in the Boolean_maker.
 * It consists of:
 *  1. BOOLEAN_VALUE_TYPE_ARRAY -> For array pointers.
 *  2. BOOLEAN_VALUE_TYPE_NON_ARRAY -> For non-array pointers.
 *  3. BOOLEAN_VALUE_TYPE_STRING_ARRAY -> For an array of strings.
 */
typedef enum BOOLEAN_VALUE {
    /**
 ...
 * 3. boolValue -> A method that checks if the value held is true or false.
 * 4. clear -> A method to clear the Boolean data type instance from memory.
 */
...
/**
 * A helper function that clears the current Boolean_type instance.
 * @attention Please use this within the Boolean_maker function, as it is internal.
 */
